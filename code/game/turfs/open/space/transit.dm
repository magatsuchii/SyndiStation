...
/turf/open/space/transit/ship

/turf/open/space/transit/ship/throw_atom(atom/movable/AM)
	. = ..()
	if(istype(AM, /mob/living/))
		var/mob/living/entity = AM
		to_chat(entity, span_danger("You watch as the ship's engines silently roar past you, leaving you alone in the depths of space."))
